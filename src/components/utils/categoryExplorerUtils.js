...
export const styles = {
  ...
  sidebarHeader: { padding: 0, borderBottom: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'center', alignItems: 'center', margin: 0, height: '0px', borderRadius: '0' },
  manageCategoryBtn: {
    ...
    width: '100%',
    height: 'auto',
    boxShadow: '0 10px 24px rgba(52, 70, 152, 0.24)',
  ...
  sidebarFooter: { padding: '12px', borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'rgba(255,255,255,0.04)', flexShrink: 0, marginTop: 'auto' },
  categoryList: { flex: 1, overflowY: 'auto', padding: '10px', minHeight: 0, display: 'flex', flexDirection: 'column', gap: '8px' },
  categoryItem: { padding: '12px', borderRadius: '12px', cursor: 'pointer', transition: 'all 0.25s ease', background: 'rgba(255,255,255,0.06)', borderLeft: '4px solid', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.06)', backdropFilter: 'blur(10px)' },
  categoryItemContent: { flex: 1 },
  categoryName: { fontWeight: '700', fontSize: '15px', color: '#f8fafc' },
  categoryItemStats: { display: 'flex', gap: '8px', flexWrap: 'wrap', fontSize: '12px', marginTop: '8px' },
